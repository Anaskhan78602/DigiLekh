...
const BlogPost = () => {
  ...
  return (
    <div className="bg-[#d4ebf8] min-h-screen relative">
      <Header />
      <div className="mt-8 max-w-3xl mx-auto bg-[#001f3f] shadow-md rounded-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              type="file"
              id="image"
              className="mt-1 w-full text-sm text-white file:mr-4 file:py-2 file:px-4 file:rounded file:border file:border file:text-sm file:font-medium file:bg-[#FBA834] file:text-white hover:file:bg-[#e38e49]"
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="bg-[#fba834] text-white px-6 py-2 rounded-md shadow-md hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
